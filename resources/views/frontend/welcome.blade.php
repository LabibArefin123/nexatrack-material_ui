...
<body class="bg-gray-50 text-gray-800">
    ...
    @include('frontend.welcome_layout.navbar')
    @include('frontend.welcome_layout.about')
    @include('frontend.welcome_layout.features')
    @include('frontend.welcome_layout.footer')
