...
@section('title', 'Add Contract Stage')

@section('content')
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h3 class="mb-0">Add New Contract Stage</h3>
    ...
    <div class="card shadow-sm">
        <div class="card-body">
            <form action="{{ route('contact_stages.store') }}" method="POST">
                @csrf
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="title" class="form-control @error('title') is-invalid @enderror"
                        value="{{ old('title') }}" placeholder="Enter stage title">
                    @error('title')
