...
@section('content')
    <div class="d-flex justify-content-between align-items-center">
        ...
        <a href="{{ route('leads.index') }}" class="btn  btn-secondary d-flex align-items-center gap-2 back-btn">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 form-group">
                        ...
                        <select name="status" class="form-control @error('status') is-invalid @enderror">
                            ...
                            <option value="not_contacted" {{ old('status') == 'not_contacted' ? 'selected' : '' }}>Not
                                Contacted
                            </option>
